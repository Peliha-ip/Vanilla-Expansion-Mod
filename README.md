...
Here's the mod that compiles all my mods into one. Can make interactions that wouldn't be possible with them on their own. If you want to have more than one of my mods, use this instead.
...
- The list of mobs incompatible with the mirror overworld has expanded. They now include: endercats (EC), enderfish (EC), enderbears (EC), enderrats (EC), enderpigs (EC), enderdogs (EC), enderrabbits (EC), bluebucks (EC), leopard seals (TCA), beavers (TCA), yetis (TCA), smilodons (TCA), moose (TCA), yaks (TCA), reindeer (TCA), snow leopards (TCA), marwhals (TCA), belugas (TCA), orcas (TCA), elephant seals (TCA), Macrauchenia (TCA), saber-tooth squirrels (TCA), fairies (TCA), leprechauns (TCA), meerkats (SR), whales (SR), pakicetus (SR), harbor seals (SR), driftfish (SR,), manatees (SR), dugongs (SR), porpoises (SR), otters (SR), sperm whales (SR), platypuses (SR), basilosauruses (SR), dorudons (SR), livyathans (SR), baijis (SR), pirates (SR), woolly rhinoceroses (TCA), lemmings (TCA), orthoceras (SR), anomalocaris (SR), hallucigenia (SR), opabinia (SR), wiwaxia (SR), tamisiocaris (SR), dickinsonia (SR), sea scorpions (SR), tully monsters (SR), dunkleosteus (SR), diadectes (BB), tunas (SR), tilapias (SR), swordfish (SR), parrotfish (SR), piranhas (SR), triggerfish (SR), tripodfish (SR), anglerfish (TCA), snailfish (TCA), fangtooth (TCA), dragonfish (TCA), viperfish (TCA), frogfish (SR), stonefish (SR), barracudas (SR), trilobites (SR), seahorses (SR), manta rays (TCA), sawfish (SR), giant squids (SR), vampire squids (TCA), cuttlefish (SR), Magnapinnas (TCA), blobfish (TCA), coconut crabs (SR), yeti crabs (TCA), sea snakes (SR), desmostylians (SR), deep-sea isopods (TCA), siphonophore (TCA), anteaters (BB), sloths (BB), ground sloths (BB), dogs (BB), mooblooms (BB), echidnas (BB), mongooses (BB), alpacas (BB), warthogs (BB), hedgehogs (BB), ferrets (BB), red pandas (BB), glyptodonts (BB), skunks (BB), squirrels (BB), hamsters (BB), raccoons (BB), coyotes (BB), porcupines (BB), monkeys (BB), chipmunks (BB), jackalopes (BB), pangolins (BB), binturongs (BB), kangaroos (BB), aardvarks (BB), cowboys (BB), jesters (TC), rascals (TC), animal tamers (TC), elephants (TC), mammoths (TC), rhinoceroses (TC), hippopotamuses (TC), hyenas (TC), lions (TC), tigers (TC), leopards (TC), walruses (TC), sea lions (TC), zebras (TC), grizzly bears (TC), poachers (TC), giraffes (TC), illusioners (TC), platybelodons (TC), puppeteers (TC), colonists (EC), cyberfish (PC), cybercats (PC), IP trackers (PC), glitchlings (PC), pop-uppers (PC), nerd creepers (PC), packet runners (PC), pixel jellies (PC), cache crabs (PC), spammers (PC), laggers (PC), emoji slimes (PC), cable snakes (PC), moderators (PC), ad drones (PC), redstone bugs (PC), malware cores (PC), shadies (PC), and kingpins (PC).
- Meanwhile, mosasaurs (SR), pterosaurs (SR), pleisiosaurs (SR), ammonites (SR), crabs (SR), lobsters (SR), hermit crabs (SR), shrimps (SR), prawns (SR), ichthyosaurs (SR), gars (SR), ceolacanths (SR), horseshoe crabs (SR), hornets (BB), crystal tortoises (EC), tortoises (BB), oysters (SR), clams (SR), mussels (SR), scallops (SR), cockles (SR), limpets (SR), abalones (SR), snails (SR), mantis shrimps (SR), sea urchins (SR), barnacles (SR), starfish (SR), anemones (SR), nudibranches (SR), conches (SR), cone snails (SR), lancelets (SR), sea squirts (SR), sand dollars (SR), flatworms (TCA), jellyfish (SR), crayfish (SR), great white sharks (SR), comb jellies (TCA), snakes (BB), scorpions (BB), centipedes (BB), millipedes (BB), ladybugs (BB), butterflies (BB), and beetles (BB) can now spawn in the mirror overworld.
- Penguins (TCA) run from walruses (TC).
- Crystal foxes (TCA) can now spawn on crystal islands (EC).
- Crystal tortoises (EC) can now spawn on Gemina (TCA).
- Harbor seals (SR) now attack carcyns (TCA), ichtrixes (TCA), comb jellies (TCA), tentrixes (TCA), cyberfish (PC), cache crabs (PC), Lepidotes (JP), enderfish (EC), and shimmerfish (EC).
- Poachers (TC) now attack meerkats (SR), whales (SR), Pakicetuses (SR), flamingos (SR), harbor seals (SR), ammonites (SR), clams (SR), oysters (SR), trilobites (SR), Anomilacaris (SR), Hallucigenias (SR), opabinias (SR), wiwaxias (SR), tamiscolaris (SR), sea scorpions (SR), dickinsonias (SR), ichtyosaurs (SR), dunkleosteus (SR), helicoprions (SR), mosasaurs (SR), albatrosses (SR), porpoises (SR), horseshoe crabs (SR), otters (SR), pelicans (SR), manatees (SR), dugongs (SR), giant squids (SR), sperm whales (SR), anemones (SR), nudibranches (SR), seahorses (SR), stingrays (SR), sea cucumbers (SR), platypuses (SR), eels (SR), sawfish (SR), sea snakes (SR), crocodiles (SR), blue-footed boobies (SR), whale sharks (SR), puffins (SR), razorbills (SR), piranhas (SR), pterosaurs (SR), pleisiosaurs (SR), frogfish (SR), conches (SR), basilosauruses (SR), dorudons (SR), livyathans (SR), baijis (SR), cormorants (SR), tully monsters (SR), orthocerases (SR), sea squirts (SR), sand dollars (SR), octopi (SR), cuttlefish (SR), desmostylian (SR), anteaters (BB), sloths (BB), ground sloths (BB), ostriches (BB), vultures (BB), mooblooms (BB), echidnas (BB), snakes (BB), glyptodonts (BB), mongoose (BB), scorpions (BB), warthogs (BB), alligators (BB), tortoises (BB), hedgehogs (BB), cluckshrooms (BB), skunks (BB), raccoons (BB), coyotes (BB), roadrunners (BB), porcupines (BB), toucans (BB), diadectes (BB), jackalopes (BB), pangolins (BB), binturongs (BB), kangaroos (BB), aardvarks (BB), cowboys (BB), cameleons (BB), leopard seals (TCA), penguins (TCA), beavers (TCA), space whales (TCA), flatworms (TCA), peacock spiders (TCA), capricorns (TCA), yetis (TCA), smilodons (TCA), moose (TCA), reindeer (TCA), snow leopards (TCA), yaks (TCA), belugas (TCA), narwhals (TCA), orcas (TCA), elephant seals (TCA), manta rays (TCA), droopy dragons (TCA), woolly rhinoceroses (TCA), murrixes (TCA), fuzzy worms (TCA), stone chickens (TCA), hippies (TCA), crystal foxes (TCA), starballoons (TCA), tentrixes (TCA), Macrauchenias (TCA), saber-tooth squirrels (TCA), fairies (TCA), leprechauns (TCA), lemmings (TCA), dinosaurs (JP), paleo-squids (JP), paleo-glow squids (JP), paleo-frogs (JP), paleo-tadpoles (JP), paleo-allays (JP), Lepidotes (JP), Xiphactinuses (JP), crestfolks (JP), saurian golems (JP), proto-mammals (JP), dimorphodons (JP), dimetrodons (JP), cable snakes (PC), moderators (PC), enderavians (EC), enderbears (EC), enderrats (EC), crystal tortoises (EC), enderrabbits (EC), shimmerfish (EC), cyberfish (PC), enderfish (EC), dodos (EC), platinum golems (EC), colonists (EC), great auks (EC), kakapos (EC), kauaʻi ʻōʻō birds (EC), passenger pigeons (EC), parakeets (EC), and bluebucks (EC).
...
- Starballoons (TCA) can now spawn near circuses (TC) and pirate carnivals (SR + TC).
- Throwing stink bombs (TCA) grants anything nearby to get the stinky effect (BB).
